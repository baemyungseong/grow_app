...
class messageDetailScreen extends StatefulWidget {
  ...
  messageDetailScreen(Required required, {Key? key, required this.uid})
      : super(key: key);

  @override
  _messageDetailScreenState createState() => _messageDetailScreenState(uid);
}
