...
class taskEditingScreen extends StatefulWidget {
  ...
  taskEditingScreen(Required required, {Key? key, required this.uid})
      : super(key: key);

  @override
  _taskEditingScreenState createState() => _taskEditingScreenState(uid);
}
